...
import { AdoptarComponent } from 'src/app/feature/adoptar/components/formulario-component/adoptar-component.component';
...
const NUMERO_DE_TELEFONO_PARA_DONACION = 573107852709;

@Component({
  selector: 'app-apadrinar-component',
  templateUrl: './apadrinar-component.component.html',
  styleUrls: ['./apadrinar-component.component.css']
})
export class ApadrinarComponent {
  ...
  public numeroTelefono: number = NUMERO_DE_TELEFONO_PARA_DONACION;
